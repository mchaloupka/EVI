...
namespace Slp.Evi.Storage.Sparql.Utils.CodeGeneration
{
        ...
        : IModifierVisitor
    {
        ...
        /// <param name="data">The passed data</param>
        /// <returns><c>true</c> if transformation should continue, <c>false</c> the fallback should be used.</returns>
        protected virtual bool ShouldTransform(OrderByModifier toTransform, T data)
        {
            return CommonShouldTransform(toTransform, data);
        }
        ...
        /// <param name="data">The passed data.</param>
        /// <returns>The transformation result</returns>
        protected virtual TR FallbackTransform(OrderByModifier toTransform, T data)
        {
            return CommonFallbackTransform(toTransform, data);
        }
        ...
        /// <param name="data">The passed data</param>
        /// <returns><c>true</c> if transformation should continue, <c>false</c> the fallback should be used.</returns>
        protected virtual bool ShouldTransform(SliceModifier toTransform, T data)
        {
            return CommonShouldTransform(toTransform, data);
        }
        ...
        /// <param name="data">The passed data.</param>
        /// <returns>The transformation result</returns>
        protected virtual TR FallbackTransform(SliceModifier toTransform, T data)
        {
            return CommonFallbackTransform(toTransform, data);
        }
        ...
        /// <param name="data">The passed data</param>
        /// <returns><c>true</c> if transformation should continue, <c>false</c> the fallback should be used.</returns>
        protected virtual bool ShouldTransform(DistinctModifier toTransform, T data)
        {
            return CommonShouldTransform(toTransform, data);
        }
        ...
        /// <param name="data">The passed data.</param>
        /// <returns>The transformation result</returns>
        protected virtual TR FallbackTransform(DistinctModifier toTransform, T data)
        {
            return CommonFallbackTransform(toTransform, data);
        }
